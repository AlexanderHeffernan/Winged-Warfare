        ...
        if (distance <= 192) {
          if (object != this) { // If object isn't self.
            if(this.left > object.left && this.right < object.right) { // If vertically aligned with object.
              if(this.bottom >= object.top && this.bottom < object.bottom) { // If collide with top of object.
            ...
            else if(this.top > object.top - this.size.y/2 && this.bottom < object.bottom + this.size.y/2) { // If horizontally aligned with object.
